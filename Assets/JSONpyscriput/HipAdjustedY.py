...
# Main function
def adjust_hip_y_to_target(json_file_path, target_average):
...
# Example usage: 
json_file_path = '/Users/kanakokunii/3DDanceFormationSimulatorForiOS/Assets/StreamingAssets/girls.json'
target_average = 0.89  # Desired average value for the second element of "hips"

adjust_hip_y_to_target(json_file_path, target_average)